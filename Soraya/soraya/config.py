...
class Settings:
    ...
    # presence/sprite.py § PACK_ROOTS. The local `Soraya` pack holds the real
    # artwork, imported so this folder works on its own — see
    # scripts/import_pack.py. The Swift app's packs are still readable in place
    # if you want to point at one.
